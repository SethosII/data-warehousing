...
CREATE TABLE Bestellungen (
  ...
  CONSTRAINT fk_Bestellungen_Zeit FOREIGN KEY (ZeitID) REFERENCES DimZeit (ZeitID) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE CrossSells (
  ...
  CONSTRAINT fk_CrossSells_Zeit FOREIGN KEY (ZeitID) REFERENCES DimZeit (ZeitID) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE Retouren (
  ...
  CONSTRAINT fk_Retouren_Zeit FOREIGN KEY (ZeitID) REFERENCES DimZeit (ZeitID) ON DELETE CASCADE ON UPDATE CASCADE
)
